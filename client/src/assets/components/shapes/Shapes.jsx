...
const Shapes = (props) => {
    ...
    return (
        <>
            ...
            {(props.pageLocation === 2) && <Triangle triangleType="triangle_type_one" trianglePlace="triangle-4" />}
            {(props.pageLocation === 3) && <Triangle triangleType="triangle_type_one" trianglePlace="triangle-3" />}
        </>
    );
}
