...
function App() {
  ...
  function calculateSectionHeight() {
    ...
    docHeight = sectionHeight * sectionNumber;
  ...
  function doSomething(scrollPos) {
    if (Math.round(scrollPos / sectionHeight) === 0) {
      setLocation(0);
    } else if (Math.round(scrollPos / sectionHeight) === 1) {
      setLocation(1);
    } else if (Math.round(scrollPos / sectionHeight) === 2) {
      setLocation(2);
